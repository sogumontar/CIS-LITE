            ...
            ['class' => 'common\components\ToolsColumn',
                ...
                'buttons' => [
                    ...
                    'approve' => function ($url, $model){
                        ...
                        }else if ($model->status_request_dosen_wali == 3 || $model->status_request_keasramaan == 3) {
                            return "";
                        }else{
                            return "";
                        }
                ...
                'urlCreator' => function ($action, $model, $key, $index){
                    ...
                    if ($action === 'view') {
                        return Url::toRoute(['ika-by-baak-view', 'id' => $key]);
                    }else if ($action === 'approve') {
                        return Url::toRoute(['approve-by-baak', 'id' => $key, 'id_baak' => $baak->pegawai_id]);
                    }else if ($action === 'reject') {
                        return Url::toRoute(['reject-by-baak', 'id' => $key, 'id_baak' => $baak->pegawai_id]);
                    }
                }
            ],
        ],
