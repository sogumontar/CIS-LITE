...
$this->params['breadcrumbs'][] = ['label' => 'Izin Keluar', 'url' => ['ika-by-dosen-index']];
...
<div class="izin-keluar-view">
    ...
    <div class="pull-right">
        ...
        <?= $uiHelper->renderButtonSet([
                ...
                'buttons' => [
                    'approve' => ['url' => Url::toRoute(['approve-by-dosen', 'id' => $model->izin_keluar_id, 'id_dosen' => $dosen->pegawai_id]), 'label'=> 'Setujui Request', 'icon'=>'fa fa-check'], // id keasramaan diambil saat sudah login
                    'reject' => ['url' => Url::toRoute(['reject-by-dosen', 'id' => $model->izin_keluar_id, 'id_dosen' => $dosen->pegawai_id]), 'label'=> 'Tolak Request', 'icon'=>'fa fa-times'],
                ],
