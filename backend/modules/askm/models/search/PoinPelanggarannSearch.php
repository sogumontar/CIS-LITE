...
/**
 * PoinPelanggarannSearch represents the model behind the search form about `backend\modules\askm\models\PoinPelanggaran`.
 */
class PoinPelanggarannSearch extends PoinPelanggaran
{
    /**
     * @inheritdoc
     */
