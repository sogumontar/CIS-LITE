                ...
                <tr>
                    ...
                    <?php   }
                        ...
                        <tr>    
                            <br>   
                            <td colspan="2">
                                <p align="center"><b>--Assisten Dosen--</b></p>
                            </td>
                        </tr>
                        <tr>    
                            <td>
                                <p><b>Nama Asisten Dosen</b></p>
                            </td>
                            <td>    
                                <p><b>Load Asisten Dosen</b></p>
                            </td>
                        </tr>
                        <?php 
                        foreach ($sta as $key) {?>
                            ...
                            <tr bgcolor="">
                                <td><input type="text" value="<?php echo $key; ?>" disabled="">
                                </td> 
                            
                                <td><input id="<?php echo $key; ?>" type="text" value="2" disabled="" name=""></td>
