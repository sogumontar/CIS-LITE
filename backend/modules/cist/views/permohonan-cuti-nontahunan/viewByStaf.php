...
<div class="permohonan-cuti-nontahunan-view">
    ...
    <?php if ($model->statusCutiNontahunan->status_by_atasan == 1 || $model->statusCutiNontahunan->status_by_wr2 == 1) { ?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-times"></i> Batalkan', ['cancel-by-staf', 'id' => $model->permohonan_cuti_nontahunan_id], ['class' => 'btn btn-warning']) ?>
            </p>
        </div>
    <?php } ?>
