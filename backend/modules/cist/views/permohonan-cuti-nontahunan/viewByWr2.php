...
<div class="permohonan-izin-view">
    ...
    <?php if ($model->statusCutiNontahunan->status_by_atasan == 6 && $model->statusCutiNontahunan->status_by_wr2 == 1) { ?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-check"></i> Setuju', ['accept-by-wr2', 'id' => $model->permohonan_cuti_nontahunan_id], ['class' => 'btn btn-success']) ?>
                <?php echo Html::a('<i class="fa fa-times"></i> Tolak', ['reject-by-wr2', 'id' => $model->permohonan_cuti_nontahunan_id], ['class' => 'btn btn-danger']); ?>
            </p>
        </div>
    <?php } ?>
