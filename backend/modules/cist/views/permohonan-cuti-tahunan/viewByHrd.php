...
$this->params['breadcrumbs'][] = ['label' => 'Permohonan Cuti Tahunan', 'url' => ['index-by-hrd']];
...
<div class="permohonan-izin-view">
    ...
    <?php if ($model->statusCutiTahunan->status_by_atasan == 6 && $model->statusCutiTahunan->status_by_wr2 == 1) { ?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-check"></i> Setuju sebagai WR 2', ['accept-by-wr2-hrd', 'id' => $model->permohonan_cuti_tahunan_id], ['class' => 'btn btn-success']) ?>
                <?php echo Html::a('<i class="fa fa-times"></i> Tolak sebagai WR 2', ['reject-by-wr2-hrd', 'id' => $model->permohonan_cuti_tahunan_id], ['class' => 'btn btn-danger']); ?>
            </p>
        </div>
    <?php } else if ($model->statusCutiTahunan->status_by_wr2 == 1) { ?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-check"></i> Setuju sebagai Atasan', ['accept-by-atasan-hrd', 'id' => $model->permohonan_cuti_tahunan_id], ['class' => 'btn btn-success']) ?>
                <?php echo Html::a('<i class="fa fa-times"></i> Tolak sebagai Atasan', ['reject-by-atasan-hrd', 'id' => $model->permohonan_cuti_tahunan_id], ['class' => 'btn btn-danger']); ?>
            </p>
        </div>
    <?php } ?>
