        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => isset($model->dilaksanakan_oleh)?$model->dilaksanakanOleh->jabatan.''.(isset($model->dilaksanakanOleh->unit->name)?' - '.$model->dilaksanakanOleh->unit->name:''):'-',
                ],
                [
