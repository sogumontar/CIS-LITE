...
/**
 * This is the model class for table "mref_r_sifat_kurikulum".
 *
 * @property integer $sifat_kurikulum_id
 ...
 */
class SifatKurikulum extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'sifat_kurikulum_id' => 'Sifat Kurikulum ID',
            'nama' => 'Nama',
            'desc' => 'Desc',
